...
# Plot 2 - Density histogram within each BMI category
ggplot(adult, aes (x = SRAGE_P, fill= factor(RBMI))) +
...
# Plot 5 - Density histogram with position = "fill" -- calculates proportion across category rather than bin.
ggplot(adult, aes (x = SRAGE_P, fill= factor(RBMI))) +
